const Block = ({ title, position, matrix, setMatrix, isSelected, password, setPassword }: any) => {
  const handleBlockClick = () => {
    ...
    if (true) {
      setMatrix(newMatrix);
      setPassword((previousPassword: string) => (previousPassword || "") + newMatrix[row][col].title);
    }
  };
